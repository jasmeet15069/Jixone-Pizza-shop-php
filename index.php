...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Jixone</span> Pizza Shop</a>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>jasmeet.15069@gmail.com</p>
         <p>jasmeetsayss@gmail.com</p>
      </div>
   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by
       <span> <a href="https://github.com/jasmeet15069/" target="_blank">
         Jasmeet Sethi
      </a>
   </span> 
   | all rights reserved!
